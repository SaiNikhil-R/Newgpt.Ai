...
const Icon: React.FC<IconProps> = ({ icon, className, ...props }) => {
  const icons = {
    ...
    loading: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.182-3.182m0 0h-4.992m4.992 0v4.992m0 0l-3.182-3.182a8.25 8.25 0 00-11.667 0l-3.181 3.182M4.5 12.5a.75.75 0 01.75-.75h3.75a.75.75 0 010 1.5H5.25a.75.75 0 01-.75-.75z" />
    ),
    image: (
